...
> **Note:** This repository is a Technical Showcase and Architectural Overview. The source code is proprietary and currently deployed in production for enterprise clients (including national archives and museums).
...
- **Portfolio:** [github.com/mdelaguera/architecture-showcase](https://github.com/mdelaguera/architecture-showcase)
